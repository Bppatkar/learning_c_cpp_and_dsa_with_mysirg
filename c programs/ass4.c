...
int main(){
  ...
  printf("sum of that three digits is %d:" );
  return 0;
}
...
// 9. What will be the value stored in the variable x after executing the following statement: x=12>-2;

// 10. What will be the value stored in the variable x after executing the following statement: x=3<0&&5>0;
